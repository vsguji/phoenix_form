...
class StepInputFormItem extends StatefulWidget {
  ...
  @override
  StepInputFormItemState createState() {
    return StepInputFormItemState();
  }
}

class StepInputFormItemState extends State<StepInputFormItem> {
  ...
  void _onControllerTextChangedHandleTicker() {
    if (_oldValue != _value) {
      FormUtil.notifyValueChanged(widget.onChanged, context, _oldValue, _value);
      setState(() {});
      _oldValue = _value;
    }
  }
