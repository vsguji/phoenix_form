...
class RadioInputFormItem extends StatefulWidget {
  ...
  @override
  RadioInputFormItemState createState() {
    return RadioInputFormItemState();
  }
}

class RadioInputFormItemState extends State<RadioInputFormItem> {
    ...
    if (options != null && options.isNotEmpty) {
      ...
      for (String? item in options) {
        ...
        double optionWidth = painter.width +
            FormUtil.optionsMiddlePadding(widget.themeData!)!.left +
