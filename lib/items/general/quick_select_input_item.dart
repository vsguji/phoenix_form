...
class TextQuickSelectFormItem extends StatefulWidget {
  ...
  @override
  TextQuickSelectFormItemState createState() {
    return TextQuickSelectFormItemState();
  }
}

class TextQuickSelectFormItemState extends State<TextQuickSelectFormItem> {
  @override
  ...
  Widget buildText() {
    if (widget.value != null && widget.value!.isNotEmpty) {
      ...
      return Text(
        ...
        textAlign: TextAlign.end,
        style: FormUtil.getHintTextStyle(widget.themeData!),
      );
    }
  }
}
