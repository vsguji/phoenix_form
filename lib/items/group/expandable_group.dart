...
/// [ExpandableGroup] to save and restore its expanded state when it is scrolled
/// in and out of view.
///
/// See also:
///
...
class _ExpansionElementState extends State<ExpandableGroup>
                      ...
                      Container(
                        ...
                        child: Offstage(
                          ...
                          child: Text(
                            // ignore: deprecated_member_use_from_same_package
                            widget.subtitle ?? "",
                            style: FormUtil.getSubTitleTextStyle(
                                widget.themeData!),
                          ),
                        ),
                      ),
