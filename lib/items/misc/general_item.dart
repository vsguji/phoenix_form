...
class GeneralFormItem extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return GeneralFormItemState();
  }
}

class GeneralFormItemState extends State<GeneralFormItem> {
  @override
      ...
      child: Column(
        ...
        children: <Widget>[
            ...
            children: <Widget>[
              Container(
                ...
                child: Row(
                  children: <Widget>[
                    Offstage(
                      offstage: widget.prefixIconType == PrefixIconType.normal,
                      child: Container(
                        ...
                        child: GestureDetector(
                          onTap: () {
                            ...
                            if (PrefixIconType.add == widget.prefixIconType) {
                              if (widget.onAddTap != null) {
                                widget.onAddTap!();
                              }
                            } else if (PrefixIconType.remove ==
                          ...
                          child: FormUtil.getPrefixIcon(widget.prefixIconType),
                        ),
                      ),
                    ),
                    Offstage(
                    ...
                    Container(
                        child: widget.titleWidget ??
                            Text(
                              widget.title,
                              style:
                                  FormUtil.getTitleTextStyle(widget.themeData!),
                            )),
                    Offstage(
          ...
          Offstage(
              ...
              child: Container(
                  padding: FormUtil.computeErrorEdgeInsets(
